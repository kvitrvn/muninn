...
func TestAdvancedFilter_Apply(t *testing.T) {
	tenders := []muninn.Tender{
		{Sources: []muninn.SourceReference{{Provider: "test", ID: "1"}}, CPVCodes: []string{"72000000"}, MontantEstime: 50000, Buyer: muninn.Buyer{SIREN: "111111111"}},
		{Sources: []muninn.SourceReference{{Provider: "test", ID: "2"}}, CPVCodes: []string{"30190000"}, MontantEstime: 500000, Buyer: muninn.Buyer{SIREN: "222222222"}},
		{Sources: []muninn.SourceReference{{Provider: "test", ID: "3"}}, CPVCodes: []string{"72500000"}, MontantEstime: 5000000, Buyer: muninn.Buyer{SIREN: "111111111"}},
		{Sources: []muninn.SourceReference{{Provider: "test", ID: "4"}}, CPVCodes: []string{"72000000"}, MontantEstime: 50000, Buyer: muninn.Buyer{SIRET: "99999999999999"}}, // SIREN9 == "999999999"
	}
	tests := []struct {
		name string
		f    AdvancedFilter
